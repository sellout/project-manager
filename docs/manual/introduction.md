...
- If you do want to build some programs from source, there is hardly a tool more useful than Nix for that, and the build instructions can be integrated in your Project Manager usage.
